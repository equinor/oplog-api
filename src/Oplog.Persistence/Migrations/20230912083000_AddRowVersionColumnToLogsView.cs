...
{
    /// <inheritdoc />
    public partial class AddRowVersionColumnToLogsView : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"ALTER VIEW LogsView
                                    AS
                                    ...
                                    l.Subtype, l.IsCritical, oa.Name AS AreaName, logtypes.Name AS LogTypeName, subtypes.Name AS SubTypeName, units.Name AS UnitName, l.RowVersion
