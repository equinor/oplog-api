...
namespace Oplog.Persistence.Migrations
{
    ...
    [Migration("20230912083000_AddRowVersionColumnToLogsView")]
    partial class AddRowVersionColumnToLogsView
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OperationAreaUnit", b =>
                {
                    b.Property<int>("OperationAreasId")
                        .HasColumnType("int");

                    b.Property<int>("UnitsId")
                        .HasColumnType("int");

                    b.HasKey("OperationAreasId", "UnitsId");

                    b.HasIndex("UnitsId");

                    b.ToTable("OperationAreaUnit");
                });
            ...
            modelBuilder.Entity("Oplog.Persistence.Models.Unit", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OperationAreaUnit", b =>
                {
                    b.HasOne("Oplog.Persistence.Models.OperationArea", null)
                        .WithMany()
                        .HasForeignKey("OperationAreasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Oplog.Persistence.Models.Unit", null)
                        .WithMany()
