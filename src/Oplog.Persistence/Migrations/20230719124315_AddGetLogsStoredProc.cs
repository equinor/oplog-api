...
{
    /// <inheritdoc />
    public partial class AddGetLogsStoredProc : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            //Create Table Valued Type
            migrationBuilder.Sql(@"CREATE TYPE Ids AS TABLE([Id] [int] NOT NULL);");

            //Create the stroed procedure
...
GO");
        ...
        {
            migrationBuilder.Sql(@"DROP TYPE Ids;");
            migrationBuilder.Sql(@"DROP PROCEDURE GetFilteredLogs;");
        }
    }
}
