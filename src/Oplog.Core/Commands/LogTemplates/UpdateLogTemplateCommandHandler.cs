...
{
    public class UpdateLogTemplateCommandHandler : ICommandHandler<UpdateLogTemplateCommand, UpdateLogTemplateResult>
    {
        ...
        public async Task<UpdateLogTemplateResult> Handle(UpdateLogTemplateCommand command)
        {
            ...
            logtemplate.OperationAreaId = command.OperationAreaId;
