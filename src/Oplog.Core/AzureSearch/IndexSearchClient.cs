...
public sealed class IndexSearchClient : SearchClientBase, IIndexSearchClient
{
    ...
    public async Task<SearchResults<LogDocument>> Search(SearchRequest searchRequest)
    {
        try
        {
            ...
            SearchOptionsBuilder searchOptionsBuilder = new(searchRequest, isDateOnlySearch);//new(searchRequest.FromDate, searchRequest.ToDate, searchRequest.PageSize, searchRequest.PageNumber, isDateOnlySearch, searchRequest.HideVisibleToAll);
